...
session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
   ...
   try {
    ...
    $sorgu = $baglanti->query("SELECT * FROM kullanicilar")->fetchAll(PDO::FETCH_ASSOC);
      ...
      <div class="page-breadcrumb">
         <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
               <h4 class="page-title">Personel Kayıt</h4>
      ...
      <div class="container-fluid text-center ">
                ...
                <div class="row justify-content-center align-items-center">
                    <table  class="table  table-striped" border=2 width="80%"  >
                        <tr>
                            <td class="col-4">Kullanıcı adi </td>
                            <td class="col-4">Şifre</td>
                        ...
                        <tr>
                            ...
                            <td><?=$person["sifre"];?></td>
                            <td><a class="btn btn-primary" href="girisalani2duzenle.php?id=<?=$person["id"];?>" > kullanıcı Düzenle</a></td> 
                            <td><a class="btn btn-danger" href="girisalani2sil.php?id=<?=$person["id"];?>"> kullanıcı Sil</a></td>
                ...
                <a class="btn btn-success btn-lg" style="width:150px;" href="girisalani2ekle.php"> kullanıcı Ekle</a>
