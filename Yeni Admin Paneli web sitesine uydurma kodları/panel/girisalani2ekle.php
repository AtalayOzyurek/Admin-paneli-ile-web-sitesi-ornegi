<?php
   ...
   session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
    ...
    if ($yazi1 <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
     ...
     $sql = "INSERT INTO girisalani2 SET resim=:resim, yazi1=:yazi1 ,yazi2=:yazi2";             
                  ...
                  <form action="" method="POST" enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-6">
                           ...
                           <input class="form-control" cols="40"  type="text" id="yazi1" name="yazi1" placeholder="Başlık Yazınız" required>
                        </div>
                        <div class="col-6">
                           <label for="exampleFormControlInput1">Yazi acıklamsaı</label>
                           <input class="form-control" type="text" id="yazi2" name="yazi2" placeholder="Yazi aciklamasi" required>
                        </div>
                     </div>
                     <div class="row">
