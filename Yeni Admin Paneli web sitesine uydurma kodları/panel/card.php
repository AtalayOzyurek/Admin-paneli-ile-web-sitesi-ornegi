...
session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
   ...
   try {
    ...
    $iletisim = $baglanti->query("SELECT * FROM kayan_resim")->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="container-fluid text-center ">
                <div class="row justify-content-center align-items-center">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">iletişim Formu</h5>
                            </div>
                            <table class="table">
                                  <thead>
                                    <tr>
                                      <th class="col-3">id</th>
                                      <th class="col-3">Resim 1</th>
                                      <th class="col-3">Resim 2</th>
                                      <th class="col-3">Acıklama</th>

                                    </tr>
                                  </thead>
                                  <?php foreach($iletisim as $person){?>
                                  <tbody>
                                    <tr>
                                      <td><?=$person["id"];?></td>
                                      <td><img src="../img/<?=$person['resim1'];?>" style="width: 40%"></td>
                                      <td><img src="../img/<?=$person['resim2'];?>" style="width: 40%"></td>
                                      <td><a class="btn btn-danger" href="cardSİL.php?id=<?=$person["id"];?>">Sil</a></td>
                                    </tr>
                                  </tbody>
                                  <?php } ?>
                            </table>
                            <a class="btn btn-success" href="cardEKLE.php">ekle</a>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Acıklama</h5>
