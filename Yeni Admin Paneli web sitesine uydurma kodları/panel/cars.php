   ...
   session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
     if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
      ...
      try {
       ...
       $sorgu = $baglanti->query("SELECT * FROM cars")->fetchAll(PDO::FETCH_ASSOC);
      ...
      <div class="page-breadcrumb">
         <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
               <h4 class="page-title">Arabalar Bilgi</h4>
    ...
    <div class="container-fluid text-center ">
        <div class="row justify-content-center align-items-center">
         <table  class="table  table-striped" border=2 width="80%"  >
            <tr>
               <td class="col-2"> Başlık  </td>
               <td class="col-2"> Aciklama</td>
               <td class="col-3"> Resim url </td>
               <td class="col-3"> Link</td>
               <td class="col-1"> Düzenle </td>
               <td class="col-1"> Sil </td>
            </tr>
            <?php foreach($sorgu as $person){?>
            <tr>
               <td>
                  <P><?=$person["baslik"];?></P>
               </td>
               <td>
                  <a class="btn btn-info" href="#" data-toggle="modal"
                     data-target="#mesaj<?= $person["id"] ?>">Oku</a>
                  <!-- Logout Modal-->
                  <div class="modal fade" id="mesaj<?= $person["id"] ?>" tabindex="-1" role="dialog"
                     ...
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           ...
                           <div class="modal-body"><?= $person["aciklama"] ?></div>
               ...
               <td><img src="../img/<?=$person['resim'];?>" style="width: 50%"></td>
               <td>
                  <a class="btn btn-info" href="#" data-toggle="modal"
                     data-target="#mesaj2<?= $person["id"] ?>">Linke Bak</a>
                  <!-- Logout Modal-->
                  <div class="modal fade" id="mesaj2<?= $person["id"] ?>" tabindex="-1" role="dialog"
                     aria-labelledby="exampleModalLabel" aria-hidden="true">
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           <div class="modal-header">
                           ...
                           <div class="modal-body"><?= $person["link"] ?></div>
                           <div class="modal-footer">
                              <button class="btn btn-secondary" type="button"
                                 data-dismiss="modal">Kapat
                              </button>
               ...
               <td><a class="btn btn-primary" href="carsDuzenle.php?id=<?=$person["id"];?>" >Düzenle</a></td>
               <td><a class="btn btn-danger" href="carsSil.php?id=<?=$person["id"];?>">Sil</a></td>
            </tr>
            <?php } ?>
         </table>
          <a class="btn btn-success btn-lg" style="width:150px;" href="carsEkle.php">Ekle</a>
        </div>
    </div>
