...
session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
   ...
   try {
    ...
    $iletisim = $baglanti->query("SELECT * FROM iletisim")->fetchAll(PDO::FETCH_ASSOC);
                            ...
                            <table class="table">
                                  <thead>
                                    <tr>
                                      ...
                                      <th scope="col-6">Acıklama</th>
                                      <th scope="col-2">Sil</th>
                                    </tr>
                                  </thead>
                                  ...
                                  <tbody>
                                    ...
                                    <div class="modal fade" id="mesaj<?= $person["id"] ?>" tabindex="-1" role="dialog"
                                      ...
                                      <td><a class="btn btn-danger" href="iletisimSil.php?id=<?=$person["id"];?>">Sil</a></td>
                                    </tr>
                                  </tbody>
                                  <?php } ?>
                            </table>
