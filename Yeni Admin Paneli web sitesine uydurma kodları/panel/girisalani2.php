...
session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
  if (isset($_SESSION['oturum'])) {         // BUNA COK GEREK YOK 
   ...
   try {
    ...
    $sorgu = $baglanti->query("SELECT * FROM girisalani2")->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="container-fluid text-center ">
                ...
                <div class="row justify-content-center align-items-center">
                    <table  class="table  table-striped" border=2 width="80%"  >
                        <tr>
                            <td class="col-3">Üst Yazi </td>
                            <td class="col-3">Alt Yazı</td>
                            <td class="col-3">Resim </td>
                            <td class="col-2">Düzenle </td>
                        ...
                        <tr>
                            <td><?=$person["yazi1"];?></td>
                            <td><?=$person["yazi2"];?></td>
                             <td><img src="../img/<?=$person["resim"];?>" style="width: 25%"></td> 
                            <td><a class="btn btn-primary" href="girisalani2duzenle.php?id=<?=$person["id"];?>" >Düzenle</a></td> 
                            <td><a class="btn btn-danger" href="girisalani2sil.php?id=<?=$person["id"];?>">Sil</a></td>
                ...
                <a class="btn btn-success btn-lg" style="width:150px;" href="girisalani2ekle.php">Ekle</a>
