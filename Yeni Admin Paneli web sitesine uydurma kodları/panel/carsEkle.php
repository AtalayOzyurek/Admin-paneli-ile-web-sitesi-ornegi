<?php
   ...
   session_start();        // admin panelinde giriş yapmadan girmemek için yazılan kod  
    ...
    if ($baslik <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
     ...
     $sql = "INSERT INTO cars SET resim=:resim, aciklama=:aciklama ,baslik=:baslik ,link=:link";             
                  ...
                  <form action="" method="POST" enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-6">
                           ...
                           <input class="form-control" cols="40" rows="5" type="text" id="baslik" name="baslik" placeholder="Başlık Yazınız" required>
                        </div>
                        <div class="col-6">
                           <label for="exampleFormControlInput1">Yazi acıklamsaı</label>
                           <input class="form-control" type="text" id="aciklama" name="aciklama" placeholder="Yazi aciklamasi" required>
                        </div>
                     </div>
                     <div class="row">
                     ...
                     <div class="col-6">
                           <label for="exampleFormControlInput1">Link Giriniz</label>
                           <input class="form-control" type="text" id="link" name="link" placeholder="" required>
                        </div>
                  </div>
